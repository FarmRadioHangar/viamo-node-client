...
module.exports = function(config) {
  ...
  return {
     ...
     *
     * *Note:*
     * The properties of this object can also be specified in underscore style
     * (camel case), which is how they are sent in the final request. (E.g.,
     * as `some_param` instead of `someParam`.)
     *
     * @example
     *
     * // Create a new survey
